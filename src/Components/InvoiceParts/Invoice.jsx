...
import { ReceiptForm } from "InvoiceParts"
    ...
    return <>
        {invoiceComponents[componentName](<>
            ...
            < div class="border-t py-2 [&>div]:w-full [&>div]:gap-2 [&>div]:flex [&>div]:place-items-center" >
                <div class="flex justify-center items-center p-5 rounded">
                    <div>
            ...
            <div class="flex flex-col">
                {
                    invoice.order.relatedItems?.bankAccounts.map(bankAccount => <>
                        <div class="flex flex-col md:flex-row gap-2 place-items-center px-3">
            ...
            <div class="flex flex-col mt-5 px-3">
                <span class="opacity-75 text-md w-fit p-2 font-bold rounded">{invoiceParts.receiptText}</span>
                <div
            ...
            />
            <a
                class="block p-2 text-md font-bold w-full mt-5 border-2 border-gray-300 bg-blue-100 hover:bg-white text-center rounded"
